...
s:set(
  ...
  'Expected to be called at least %s time(s), but was called %s time(s)'
)
s:set(
  'assertion.called_at_most.positive',
  'Expected to be called at most %s time(s), but was called %s time(s)'
)
s:set(
...
s:set(
  ...
  'Expected to be called with %s argument(s), but was called with %s'
)
s:set(
...
s:set(
  ...
  "the '%s' function requires a minimum of %s arguments, got: %s"
)
