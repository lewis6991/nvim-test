...
s:set(
  ...
  'Verwachtte objecten die vergelijkbaar zijn.\nAangeboden:\n%s\nVerwachtte:\n%s'
)
s:set(
  'assertion.same.negative',
  'Verwachtte objecten die niet vergelijkbaar zijn.\nAangeboden:\n%s\nVerwachtte niet:\n%s'
)

s:set(
  'assertion.equals.positive',
  'Verwachtte objecten die hetzelfde zijn.\nAangeboden:\n%s\nVerwachtte:\n%s'
)
s:set(
  'assertion.equals.negative',
  'Verwachtte objecten die niet hetzelfde zijn.\nAangeboden:\n%s\nVerwachtte niet:\n%s'
)
...
s:set(
  ...
  "de '%s' functie verwacht minimaal %s parameters, maar kreeg er: %s"
)
s:set(
  'assertion.internal.badargtype',
  "bad argument #%s: de '%s' functie verwacht een %s als parameter, maar kreeg een: %s"
)
