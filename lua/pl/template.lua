...
local format, strsub, strfind, strgsub, strrep =
  string.format, string.sub, string.find, string.gsub, string.rep
...
local function parseHashLines(chunk, inline_escape, brackets, esc, newline)
  ...
  local pieces, s =
    { 'return function() local __R_size, __R_table, __tostring = 0, {}, __tostring; ' }, 1
  while true do
